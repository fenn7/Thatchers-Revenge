...
import static net.fenn7.thatchermod.commonside.item.custom.grenade.GrenadeLauncherInventory.listTagName;
import static net.fenn7.thatchermod.commonside.item.custom.grenade.GrenadeLauncherInventory.nbtTagName;
