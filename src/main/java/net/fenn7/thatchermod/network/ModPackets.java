...
public class ModPackets {
    ...
    public static final Identifier GRENADE_ID = new Identifier(ThatcherMod.MOD_ID, "grenade");

    public static void registerC2SPackets() {
        ServerPlayNetworking.registerGlobalReceiver(LAUNCH_ID, LaunchC2SPacket::receive);
        ServerPlayNetworking.registerGlobalReceiver(GRENADE_ID, GLauncherC2SPacket::receive);
    }
