...
public class CursedMeteorRenderer extends EntityRenderer<CursedMeteorEntity> {
    private static final Identifier TEXTURE = new Identifier("textures/entity/thatcher/cursed_meteor.png");
    ...
    protected int getBlockLight(CursedMeteorEntity dragonFireballEntity, BlockPos blockPos) {
        return 15;
    }
